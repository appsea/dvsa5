...
export function share(args: EventData): void {
    SocialShare.shareText("https://play.google.com/store/apps/details?id=exuberant.dvsa.cttk\n" +
...
export function privacyPolicy(args: EventData): void {
    utils.openUrl("https://github.com/exuberantavatar/ukdriving/blob/master/PrivacyPolicy.md");
}
