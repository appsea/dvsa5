...
export function onNavigatingTo(args: NavigatedData) {
    ...
    mySwitch.on("checkedChange", (swargs) => {
        ...
        pageData.set("complete", _subTopic && _subTopic.complete);
...
export function goPrevious(args) {
    const subTopic: ISubTopic = TopicService.getInstance().findSubTopicFromLink("topics/vru/introduction-page");
    navigationModule.gotoChapters(subTopic);
}

export function goNext(args) {
    const subTopic: ISubTopic = TopicService.getInstance().findSubTopicFromLink("topics/vru/children-page");
    navigationModule.gotoChapters(subTopic);
}
